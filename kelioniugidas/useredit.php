...
if (!in_array($_SESSION['prev'], ["procuseredit", "useredit"])){
    ...
    $_SESSION['dailyminutes'] = $_SESSION['dailyminutes'];
                    ...
                    <tr><td>
                        ...
                        <form action="procuseredit.php" method="POST" class="login">             
                            ...
                            <p style="text-align:left;">Aktyvumo lygis (minutės per dieną kelionėms):<br>
                                ...
                                <input class="s1" name="dailyminutes" type="number" min="1" max="1440" value="<?php echo $_SESSION['dailyminutes'] ?? $_SESSION['dailyminutes'] ?? ''; ?>"><br>
